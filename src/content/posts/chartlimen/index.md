...
坏处是，若游玩比例不囊括在设计比例中（比如各品牌平板诡异的比例）差分将不会出现。影响大，长时间的视觉效果还是不建议应用这个思路。相信各位能挖掘出更有趣的玩法w

好巧不巧，*某pj选手*  在更早就发现了这个特性，并尝试将其应用到表演当中。更有趣、复杂的效果可以看看他的0pj投稿。（猜猜是哪张谱
...
因为phira不适配rpe1.7子父线，所以截稿后降回1.6适配了一下。
